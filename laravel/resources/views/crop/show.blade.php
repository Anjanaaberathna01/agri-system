...
<head>
    ...
    <title>{{ $crop->name }} - Govi Saviya LK</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .product-image-nav.left { inset-inline-start: 12px; }
        ...
        .description { color: #555; line-height: 1.8; margin-block-end: 2rem; font-size: 1rem; }
        .product-meta { display: flex; gap: 2rem; margin-block-end: 2rem; flex-wrap: wrap; }
        .meta-item { display: flex; flex-direction: column; }
        .meta-item label { font-size: 0.85rem; color: #999; margin-block-end: 0.3rem; font-weight: 600; }
        ...
        .related-products h2 { font-size: 1.75rem; color: #333; margin-block-end: 1.5rem; font-weight: 700; }
        ...
        @media (max-inline-size: 768px) {
            ...
            .product-image { block-size: 300px; }
            .action-buttons { flex-direction: column; }
            .btn { inline-size: 100%; }
            .quantity-selector { inline-size: 100%; }
        ...
        @media (max-inline-size: 480px) {
            ...
            .price { font-size: 1.5rem; }
            .product-image { block-size: 250px; }
